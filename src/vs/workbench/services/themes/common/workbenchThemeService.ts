...
export enum ThemeSettingDefaults {
	COLOR_THEME_DARK = 'Default raspberryai Dark',
	COLOR_THEME_LIGHT = 'Default raspberryai Light',
	COLOR_THEME_HC_DARK = 'Default High Contrast',
	COLOR_THEME_HC_LIGHT = 'Default High Contrast Light',

	COLOR_THEME_DARK_OLD = 'Default raspberryai Dark',
	COLOR_THEME_LIGHT_OLD = 'Default raspberryai Light',
