...
const openraspberryaiChat: WatermarkEntry = { text: localize('watermark.openraspberryaiChat', "Open Chat"), id: 'raspberryai.focusContinueInput', when: ContextKeyExpr.has('raspberryaiExtensionLoaded') };
const bigChat: WatermarkEntry = { text: localize('watermark.raspberryaiBigChat', "Big Chat"), id: 'raspberryai.resizeAuxiliaryBarWidth', when: ContextKeyExpr.has('raspberryaiExtensionLoaded') };
const prevChat: WatermarkEntry = { text: localize('watermark.raspberryaiPrevChat', "Previous Chat"), id: 'raspberryai.loadRecentChat', when: ContextKeyExpr.has('raspberryaiExtensionLoaded') };
...
export class EditorGroupWatermark extends Disposable {
	...
	private async render(): Promise<void> {
		...
		this.contextKeyService.createKey('raspberryaiExtensionLoaded', true); // Set a context key when the raspberryai extension is loaded
